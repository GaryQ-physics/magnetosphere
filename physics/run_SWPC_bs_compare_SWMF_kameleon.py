...
def plot_explore():
    ...
    plt.plot(dtimes, dB_kam_norm2-dB_kam_norm1, label='dB_kam_norm2-dB_kam_norm1', alpha=0.7)
    plt.plot(dtimes, dB_kam_norm3-dB_kam_norm2, label='dB_kam_norm3-dB_kam_norm2', alpha=0.7)
    plt.plot(dtimes, dB_kam_norm3-dB_SWMF_norm, label='dB_kam_norm3-dB_SWMF_norm', alpha=0.7)
